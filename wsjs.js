...
let f_inj='<script>function PopUpShow(){$("#admmessage-popup1").css({"visibility":"visible","opacity":1});}function PopUpHide(){$("#admmessage-popup1").css({"visibility":"hidden","opacity":1});}</script>';
